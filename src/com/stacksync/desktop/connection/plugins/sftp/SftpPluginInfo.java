 ...
 */
public class SftpPluginInfo extends PluginInfo {
    public static final String ID = "sftp";
    private ResourceBundle resourceBundle;

    public SftpPluginInfo() { 
    ...
    public String getName() {
        return resourceBundle.getString("sftp_name");
    }
    ...
    public String getDescripton() {
        return resourceBundle.getString("sftp_description");
    }
