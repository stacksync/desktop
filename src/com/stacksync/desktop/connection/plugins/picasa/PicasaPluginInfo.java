 ...
 */
public class PicasaPluginInfo extends PluginInfo {
    public static final String ID = "picasa";
    private ResourceBundle resourceBundle;

    public PicasaPluginInfo() {
    ...
    public String getDescripton() {
        return resourceBundle.getString("picasa_plugin_description");
    }

    @Override
    public Connection createConnection() {
        return new PicasaConnection();
    }
}
