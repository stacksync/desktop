 ...
 */
public class WebdavPluginInfo extends PluginInfo {	
	private ResourceBundle resourceBundle;

    public WebdavPluginInfo() {
    ...
    public String getName() {
        return resourceBundle.getString("webdav_name");
    }
    ...
    public String getDescripton() {
        return resourceBundle.getString("webdav_plugin_description");
    }
